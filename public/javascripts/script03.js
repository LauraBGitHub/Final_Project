...
const polygonRPCURL = "https://polygon-mumbai.infura.io/v3/8f75a168d2484932b916f63335ac578f"; 
const web3 = new Web3(new Web3.providers.HttpProvider(polygonRPCURL));

const oracleAddress = '0x327e23a4855b6f663a28c5161541d69af8973302';
const oracleABI = [
    {
      inputs: [
        ...
        { internalType: "int256", name: "_minSubmissionValue", type: "int256" },
        { internalType: "int256", name: "_maxSubmissionValue", type: "int256" },
    ...
    {
      inputs: [
        { internalType: "address[]", name: "_removed", type: "address[]" },
        { internalType: "address[]", name: "_added", type: "address[]" },
        { internalType: "address[]", name: "_addedAdmins", type: "address[]" },
        { internalType: "uint32", name: "_minSubmissions", type: "uint32" },
        { internalType: "uint32", name: "_maxSubmissions", type: "uint32" },
        { internalType: "uint32", name: "_restartDelay", type: "uint32" },
      ],
      name: "changeOracles",
      outputs: [],
      stateMutability: "nonpayable",
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint32", name: "_queriedRoundId", type: "uint32" },
      ],
      name: "oracleRoundState",
      outputs: [
        { internalType: "bool", name: "_eligibleToSubmit", type: "bool" },
        { internalType: "uint32", name: "_roundId", type: "uint32" },
        { internalType: "int256", name: "_latestSubmission", type: "int256" },
        ...
        { internalType: "uint8", name: "_oracleCount", type: "uint8" },
        { internalType: "uint128", name: "_paymentAmount", type: "uint128" },
      ],
      stateMutability: "view",
      type: "function",
    ...
    },
    {
      inputs: [
        ...
        { internalType: "uint32", name: "_delay", type: "uint32" },
      ],
    ...
    },
    {
      inputs: [
        ...
        { internalType: "int256", name: "_submission", type: "int256" },
      ],
      name: "submit",
      outputs: [],
      stateMutability: "nonpayable",
